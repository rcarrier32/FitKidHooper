...
export const MASTERY_TRACKS = [
  ...
  },
  {
    ...
    stages: [
      ...
      { id: "eurostep-3", name: "Freak Step", inspo: "Giannis Antetokounmpo", emoji: "🦌", flavor: "Free-throw line to the rim in two giant steps.",
        color: "#f59e0b", rarity: "epic",
      ...
      { id: "eurostep-4", name: "Unblockable", inspo: "Euro Conquest", emoji: "👑", flavor: "Two long steps nobody can cut off. The peak of the Euro.",
        color: "#f59e0b", rarity: "legendary", conquest: true,
