...
const MAP = [
  ...
  { key:"squad", emoji:"👥", title:"Squad", blurb:"Friends, messages & squad challenges.", to:"squad",
    items:[
  ...
  { key:"boards", emoji:"🏆", title:"Challenges & leaderboards", blurb:"Personal goals & rankings.", to:"boards",
    items:[
      { label:"Age-group & friends leaderboards" },
      { label:"Personal weekly challenges" },
      { label:"Train Like Legends paths" },
    ] },
