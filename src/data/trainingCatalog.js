...
const W_SPEED = [
  { id:"ladder",    name:"Agility Ladder Drills",    tag:"Foundation", sets:"3 rounds", rest:"45 s",
    ...
    videoId:"_3J1tzI63b4", videoChannel:"Criticalbench", videoTitle:"Agility Ladder Drills for Kids" },
  { id:"cone-cod",  name:"Cone Change of Direction", tag:"COD",        sets:"5x each dir", rest:"30 s",
    ...
    videoId:"WK5XFcmxS7A", videoChannel:"Willamette Univ. Men's Basketball", videoTitle:"Agility & Defense Cone Drills" },
  { id:"5-10-5",    name:"Pro Agility 5-10-5",       tag:"Speed",      sets:"4-6 reps", rest:"60 s",
    ...
    videoId:"SBx-chygCdE", videoChannel:"PLT4M", videoTitle:"Pro Agility Drill (5-10-5)" },
  { id:"lat-bounds",name:"Lateral Bounds to Sprint",  tag:"Power",      sets:"3x5 each side", rest:"45 s",
    ...
    videoId:"TWAPkD1smq4", videoChannel:"ken whittier", videoTitle:"Lateral Bound Progressions" },
  { id:"def-slide", name:"Defensive Slide + Sprint",  tag:"Basketball", sets:"3x full court", rest:"60 s",
    ...
    videoId:"Vu-2wL-dt7Q", videoChannel:"Simple Speed Coach", videoTitle:"Lateral Shuffle to Sprint — Simple Speed Coach" },
];
...
const W_BALANCE = [
  { id:"sl-hold",   name:"Single Leg Balance Hold",  tag:"Foundation", sets:"3x30-45s each", rest:"15 s",
    ...
    videoId:"Z9_ThjKQyOg", videoChannel:"Children's Hospital Colorado", videoTitle:"Single Leg Balance — Childrens Hospital Colorado" },
  { id:"bosu-sq",   name:"BOSU Squats",               tag:"Balance",    sets:"3x8", rest:"45 s",
    ...
    videoId:"h-Wh6dNHq8I", videoChannel:"KP Sports Performance", videoTitle:"Top 7 Single Leg Plyometric Drills" },
  ...
  { id:"sl-squat",  name:"Single Leg Squat (Box)",    tag:"Strength",   sets:"3x8 each", rest:"30 s",
    ...
    videoId:"uJ4eA2wUXdw", videoChannel:"Bodybuilding.com", videoTitle:"Single-Leg Squat To Box — Exercise Guide" },
  { id:"lat-stick", name:"Lateral Bounds — Stick It", tag:"Power Ctrl", sets:"3x6 each leg", rest:"30 s",
    ...
    videoId:"XDBHOQoAa3w", videoChannel:"Champion Physical Therapy and Performance", videoTitle:"Lateral Bound with Stick Landing" },
  { id:"triple-lat-hops", name:"Triple Lateral Hops", tag:"Reactive Balance", sets:"3x5 each side", rest:"45 s",
    ...
    videoId:"AezzGLeOTss", videoChannel:"PJFPerformance", trusted:true, videoTitle:"Triple Lateral Hops — Lateral Bound & Stick" },
  { id:"pogo-hops", name:"Pogo Hops", tag:"Reactive Balance", sets:"3x15 reps", rest:"45 s",
    ...
    videoId:"j0nl5dWuqN4", videoChannel:"Runna", videoTitle:"Pogo Jump Tutorial — Proper Form" },
  { id:"sl-balance-reach",  name:"Single Leg Balance Reach",       tag:"Proprioception", sets:"3x8 each leg", rest:"20 s",
    ...
    videoId:"TShLyAkKU9c", videoChannel:"TrainingTrendz", videoTitle:"Single Leg Balance and Reach" },
];
...
const W_STRENGTH = [
  { id:"goblet-sq",   name:"Goblet Squat",            tag:"Day 1 Squat",      sets:"3x10", rest:"60 s",
    ...
    videoId:"CkFzgR55gho", videoChannel:"Physique Development", videoTitle:"How to Perform the Goblet Squat" },
  { id:"pushup",      name:"Push-Ups",                 tag:"Day 1 Push",       sets:"3x10-15", rest:"60 s",
    ...
    videoId:"c-lBErfxszs", videoChannel:"Davis Diley", videoTitle:"Perfect Push-Ups (Chest to Floor)" },
  { id:"tricep-dips", name:"Tricep Dips", tag:"Day 1 Push", sets:"3x10-12", rest:"45 s",
    ...
    videoId:"N3hB8rDErZI", videoChannel:"Julie Lee Physiotherapy", videoTitle:"Tricep Dips" },
  { id:"step-ups",    name:"Step-Ups",                 tag:"Day 1 Single Leg", sets:"3x8 each", rest:"45 s",
    ...
    videoId:"aKj-6hgiViA", videoChannel:"Colossus Fitness", videoTitle:"How to Properly Perform Dumbbell Step-Ups" },
  { id:"db-rows",     name:"Dumbbell Rows",            tag:"Day 1 Pull",       sets:"3x10 each", rest:"60 s",
    ...
    videoId:"Fl0UMfdEzsE", videoChannel:"Zack Henderson", videoTitle:"Inverted Rows — Beginner to Advanced" },
  { id:"plank-hold",  name:"Plank Hold",               tag:"Day 1 Core",       sets:"3x45s", rest:"30 s",
    ...
    videoId:"pSHjTRCQxIw", videoChannel:"ScottHermanFitness", videoTitle:"Plank Hold — Proper Form" },
  { id:"walk-lunge",  name:"Walking Lunges",           tag:"Day 2 Lunge",      sets:"3x10 each", rest:"45 s",
    ...
    videoId:"L8fvypPrzzs", videoChannel:"CrossFit", videoTitle:"Walking Lunges — Proper Form" },
  { id:"glute-bridge",name:"Glute Bridges",            tag:"Day 2 Hinge",      sets:"3x12", rest:"30 s",
    ...
    videoId:"wPM8icPu6H8", videoChannel:"Well+Good", videoTitle:"Glute Bridge — How To" },
  { id:"side-plank",  name:"Side Plank",               tag:"Day 2 Core",       sets:"3x20s each", rest:"20 s",
    ...
    videoId:"m8lSq4SC_eM", videoChannel:"Dublin 2 Chiropractic", videoTitle:"Beginner Core — Plank Side Plank Dead Bug" },
  { id:"box-jump",    name:"Box Jumps",                tag:"Day 3 Power",      sets:"3x5", rest:"90 s",
    ...
    videoId:"kNIInK_Le8I", videoChannel:"National Academy of Sports Medicine (NASM)", videoTitle:"How to Do Beginner Box Jumps" },
  { id:"db-deadlift", name:"Dumbbell Deadlift",        tag:"Day 3 Hinge",      sets:"3x8", rest:"60 s",
    ...
    videoId:"-FN9IgWFiTU", videoChannel:"Simple Speed Coach", videoTitle:"RDL Hip Hinge Pattern Development" },
  { id:"ohp",         name:"Overhead Press",           tag:"Day 3 Push",       sets:"3x8", rest:"60 s",
    ...
    videoId:"LmrjCwMo1ZQ", videoChannel:"KP Sports Performance", videoTitle:"Basketball Upper Body Strength — Coach Kyle" },
  { id:"split-sq",    name:"Split Squats",             tag:"Day 3 Single Leg", sets:"3x6 each", rest:"60 s",
    ...
    videoId:"Wcmg-3iHwjQ", videoChannel:"OPEX Fitness", videoTitle:"Dumbbell Split Squat" },
  { id:"hollow-hold", name:"Hollow Body Hold",         tag:"Day 3 Core",       sets:"3x hold to fatigue", rest:"30 s",
    ...
    videoId:"0yPin8hSc8o", videoChannel:"FIT.nl", videoTitle:"Hollow Body Hold — Proper Form Tutorial" },
  { id:"dead-bug", name:"Dead Bug", tag:"Day 1 Core", sets:"3x6 each side", rest:"30 s",
    ...
    videoId:"bxn9FBrt4-A", videoChannel:"National Academy of Sports Medicine (NASM)", videoTitle:"Dead Bug Exercise — Proper Form | NASM" },
  { id:"v-ups", name:"V-Ups", tag:"Day 2 Core", sets:"3x10-12", rest:"30 s",
    ...
    videoId:"Wks3wpNJqTg", videoChannel:"802 CrossFit", videoTitle:"V-Ups" },
  { id:"reverse-lunge",    name:"Reverse Lunges",                  tag:"Day 2 Lunge",    sets:"3x10 each leg", rest:"45 s",
    ...
    videoId:"3XDriUn0udo", videoChannel:"Mind Pump TV", videoTitle:"Reverse Lunges — Proper Form" },
  { id:"bw-squats",        name:"Bodyweight Squats",                tag:"Day 1 Squat",    sets:"3x15", rest:"45 s",
    ...
    videoId:"I7Nk1RMtcLs", videoChannel:"Shawn Adair", videoTitle:"How to Bodyweight Squat (Fix Squat Form)" },
  { id:"str-full",    name:"Youth Strength Full Session",tag:"Full Workout",   sets:"Follow video", rest:"As directed",
    ...
    videoId:"3shedfyWTho", videoChannel:"PowerLux Fitness ", videoTitle:"Strength and Power Exercises for Youth Athletes" },
];
...
const W_STRENGTH_EXTRA = [
  { id:"bear-crawl",  name:"Bear Crawl",               tag:"Bonus Movement", sets:"3x20 yards", rest:"30 s",
    ...
    videoId:"U3Y58Kyw7Xw", videoChannel:"Runna", videoTitle:"Bear Crawl Exercise — Tutorial" },
  { id:"broad-jump",  name:"Broad Jumps",               tag:"Bonus Power",    sets:"3x5", rest:"60 s",
    ...
    videoId:"4e-5E2J0j8o", videoChannel:"HansenAthletics", videoTitle:"Continuous Broad Jumps" },
  { id:"skater-jumps",name:"Skater Jumps",              tag:"Bonus Lateral",  sets:"3x10 each side", rest:"45 s",
    ...
    videoId:"qM5jviFhw9U", videoChannel:"Athletic Institute", videoTitle:"Skater Jumps" },
  { id:"farmers-carry",name:"Farmer Carry",            tag:"Bonus Carry",    sets:"3x30 yards", rest:"45 s",
    ...
    videoId:"DxUNi119Qzs", videoChannel:"PureGym", videoTitle:"Dumbbell Farmer Carry — How To" },
  { id:"jump-rope",   name:"Jump Rope",                 tag:"Bonus Conditioning",sets:"5x1 min", rest:"30 s",
    ...
    videoId:"xVM5s3DdE24", videoChannel:"The Spot Athletics", videoTitle:"Youth Speed and Agility Training — Ages 8-10" },
];
...
const W_EXPLOSION = [
  { id:"pogo-jumps", name:"Pogo Jumps", tag:"PJF Elasticity", sets:"3x20 reps", rest:"60 s",
    ...
    trainer:"PJF Performance", videoId:"-dNKKNwYTM8", videoChannel:"Global Triathlon Network", videoTitle:"Pogo Jumps — PJF Performance" },
  { id:"jump-lunge", name:"Jumping Lunges", tag:"Plyo Power", sets:"3x8 each leg", rest:"60 s",
    ...
    videoId:"acLvV5Gwi7o", videoChannel:"Forty Steps", videoTitle:"Jumping Lunges" },
  { id:"single-leg-hops", name:"Single Leg Hops", tag:"PJF Reactive", sets:"3x8 each leg", rest:"60 s",
    ...
    trainer:"PJF Performance", videoId:"7WgzHOQGgYw", videoChannel:"Elevate Yourself", videoTitle:"Single Leg Hops — PJF Performance" },
  { id:"lateral-bounds-pjf", name:"Lateral Bounds", tag:"PJF Lateral", sets:"3x8 each side", rest:"60 s",
    ...
    trainer:"PJF Performance", videoId:"gjiZLF5S6aA", videoChannel:"Simple Speed Coach", videoTitle:"Lateral Bounds — PJF Performance" },
  { id:"reactive-pogos", name:"Reactive Pogos", tag:"PJF Reactive", sets:"3x15 reps", rest:"60 s",
    ...
    trainer:"PJF Performance", videoId:"lz6BM6WyJ0k", videoChannel:"Swift Movement Academy", videoTitle:"Reactive Pogos — PJF Performance" },
  { id:"broad-jump-stick", name:"Broad Jump Stick Landing", tag:"PJF Power", sets:"3x5", rest:"90 s",
    ...
    videoId:"Fhz-s_Hqo8I", videoChannel:"uoasportsagility", videoTitle:"Broad Jump to Stick — Landing Control" },
  { id:"squat-jumps", name:"Squat Jumps", tag:"PJF Power", sets:"3x8", rest:"90 s",
    ...
    trainer:"PJF Performance", videoId:"U4s4mEQ5VqU", videoChannel:"Howcast", videoTitle:"Squat Jumps — PJF Performance" },
  { id:"tuck-jumps", name:"Tuck Jumps", tag:"PJF Power", sets:"3x6", rest:"90 s",
    ...
    trainer:"PJF Performance", videoId:"IcfbOBftn5c", videoChannel:"Live Lean TV Daily Exercises", videoTitle:"Pogo Jump to Tuck Jump — PJF Performance" },
  { id:"snap-downs", name:"Snap Downs", tag:"PJF Landing", sets:"3x8", rest:"60 s",
    ...
    trainer:"PJF Performance", videoId:"fXWPPaRdybI", videoChannel:"UofL Health", videoTitle:"Snap Downs — PJF Performance" },
  { id:"depth-drop", name:"Depth Drop Landing", tag:"PJF Landing", sets:"3x6", rest:"60 s",
    ...
    trainer:"PJF Performance", videoId:"ol4VhEANoQs", videoChannel:"Simple Speed Coach", videoTitle:"Depth Drop Landing — Landing Mechanics" },
  { id:"lateral-line-hops", name:"Lateral Line Hops", tag:"PJF Elasticity", sets:"3x20 s", rest:"45 s",
    ...
    trainer:"PJF Performance", videoId:"dZKEw4zDL_c", videoChannel:"HASfit", videoTitle:"Lateral Line Hops — PJF Performance" },
  { id:"pogo-tutorial",     name:"Pogo Jump Tutorial",             tag:"PJF Technique",  sets:"2x20 reps", rest:"60 s",
    ...
    trainer:"PJF Performance", videoId:"j0nl5dWuqN4", videoChannel:"Runna", videoTitle:"Pogo Jump Tutorial" },
  { id:"single-leg-pogo",   name:"Single Leg Pogo Jumps",         tag:"PJF Elasticity", sets:"3x12 each leg", rest:"60 s",
    ...
    trainer:"PJF Performance", videoId:"48hYRGlXvHw", videoChannel:"The Soccer Specialist", videoTitle:"Single Leg Pogo Jumps" },
  { id:"lat-skater-hops",   name:"Lateral Skater Hops",           tag:"PJF Lateral",    sets:"3x10 each side", rest:"60 s",
    ...
    trainer:"PJF Performance", videoId:"gS4F_YrwZVs", videoChannel:"Mike | J2FIT Strength & Conditioning", videoTitle:"Lateral Skater Hops" },
  { id:"power-bounds-series", name:"Power Bounds Series", tag:"Horizontal Power", sets:"3×3 bounds", rest:"90 s",
    ...
    trainer:"PJF Performance", videoId:"p24gY-uIlz4", videoChannel:"Will Ratelle", videoTitle:"Broad Jumps + Bounds + Sprint" },
  ...
  { id:"drop-jump",         name:"Drop Jump",                      tag:"PJF Reactive",   sets:"3x6", rest:"90 s",
    ...
    trainer:"PJF Performance", videoId:"LrZuW-sJPBo", videoChannel:"Champion Physical Therapy and Performance", videoTitle:"Drop Jump Exercise" },
  { id:"snap-down-prog",    name:"Snap Down Progression",          tag:"PJF Landing",    sets:"3x8", rest:"60 s",
    ...
    trainer:"PJF Performance", videoId:"_YudFDcW_Iw", videoChannel:"The Movement System", videoTitle:"Snap Down Progression" },
  { id:"pogo-to-tuck",      name:"Pogo Jump to Tuck Jump",         tag:"PJF Combo",      sets:"3x6 combos", rest:"90 s",
    ...
    trainer:"PJF Performance", videoId:"IcfbOBftn5c", videoChannel:"Live Lean TV Daily Exercises", videoTitle:"Pogo Jump to Tuck Jump" },
  { id:"vj-progression",    name:"Vertical Jump Progression",      tag:"PJF Program",    sets:"Follow video", rest:"As directed",
    ...
    trainer:"Plyomorph", videoId:"ihapleg--po", videoChannel:"Plyomorph", videoTitle:"Home Plyometrics Vertical Jump Workout" },
  { id:"full-plyo-workout",  name:"Full Plyometric Workout",        tag:"PJF Program",    sets:"Follow video", rest:"As directed",
    ...
    trainer:"PJF Performance", videoId:"MNUxK3mbL0c", videoChannel:"Triformance Sports Training", videoTitle:"Full Plyometric Workout" },
  { id:"dunk-training",      name:"Dunk Training Plyometrics",      tag:"PJF Hoops",      sets:"Follow video", rest:"As directed",
    ...
    trainer:"The Lost Breed", videoId:"QRN1Yzo0hjU", videoChannel:"The Lost Breed", videoTitle:"3 Exercises To Increase Your Vertical" },
];
...
const W_HANDLES = [
  { id:"tennis-dribble", name:"Tennis Ball Toss + Dribble", tag:"Hand-Eye",
    ...
    trainer:"RTG Backyard Series", videoId:"nozHTvLyL0o", videoChannel:"Pro Training Basketball", videoTitle:"Tennis Ball Basketball Dribbling — 4 Variations" },
  { id:"tennis-wall",    name:"Tennis Ball Wall Toss",       tag:"Reaction",
    ...
    trainer:"NewAge Elite Sports", videoId:"Tq1wIt3cZK0", videoChannel:"NewAgeEliteSports", videoTitle:"Tennis Ball Ball-Handling Drills" },
  { id:"weak-hand",      name:"Weak Hand Development",        tag:"Off-Hand",
    ...
    trainer:"Get Handles Basketball", videoId:"O4x_AQVZ_nI", videoChannel:"Get Handles Basketball", trusted:true, videoTitle:"Weak Hand Workout: Dribbling & Layups" },
  { id:"two-ball",       name:"Two Ball Dribbling",            tag:"Coordination",
    ...
    trainer:"DJ Sackmann · HoopStudy", videoId:"3N92fry2Jdw", videoChannel:"HoopStudy", trusted:true, videoTitle:"Two Ball Dribble Challenge — DJ Sackmann" },
  { id:"sackmann-hesi",   name:"Hesitation Move Breakdown",    tag:"DJ Sackmann",
    ...
    trainer:"DJ Sackmann · HoopStudy", videoId:"j4opotx5ZQI", videoChannel:"HoopStudy", trusted:true, videoTitle:"Hesitation Drill Breakdown — DJ Sackmann" },
  { id:"relph-twoball",   name:"Two Ball Combo Move",           tag:"Tyler Relph",
    ...
    trainer:"Tyler Relph · Hoop Dynamic", videoId:"fR6O8m48sg0", videoChannel:"Tyler Relph's Hoop Dynamic", trusted:true, videoTitle:"Advanced Two Ball Drill — Tyler Relph" },
];
...
const W_CONDITIONING = [
  { id:"down-ups",         name:"Down Ups",                        tag:"Conditioning",   sets:"3x10", rest:"30 s",
    ...
    videoId:"Au8-FTy1smY", videoChannel:"Live Lean TV Daily Exercises", videoTitle:"Down Ups — Get Up Fast Exercise" },
  { id:"burpees",          name:"Burpee Progression",              tag:"Conditioning",   sets:"3x8", rest:"45 s",
    ...
    videoId:"TU8QYVW0gDU", videoChannel:"CrossFit", videoTitle:"Burpee Progression" },
  { id:"mountain-climbers", name:"Mountain Climbers",              tag:"Core + Cardio",  sets:"3x20 s", rest:"30 s",
    ...
    videoId:"nmwgirgXLYM", videoChannel:"Howcast", videoTitle:"Mountain Climbers — Cross Body" },
  { id:"cross-mt-climbers", name:"Cross-Body Mountain Climbers",   tag:"Core + Cardio",  sets:"3x20 s", rest:"30 s",
    ...
    videoId:"nmwgirgXLYM", videoChannel:"Howcast", videoTitle:"Cross Body Mountain Climbers" },
  { id:"high-knees",       name:"High Knees",                      tag:"Conditioning",   sets:"3x20 s", rest:"30 s",
    ...
    videoId:"GjTALVhkSuw", videoChannel:"TJSportsPrograms", videoTitle:"High Knees In-Place" },
  { id:"fast-feet",        name:"Fast Feet Drill",                 tag:"Quickness",      sets:"3x15 s", rest:"30 s",
    ...
    videoId:"RvYB5qI8Urk", videoChannel:"Basketball Coach Allen", videoTitle:"Fast Feet — Top 5 Foot Speed Drills" },
  { id:"crab-walks",       name:"Crab Walks",                      tag:"Full Body",      sets:"3x20 yards", rest:"30 s",
    ...
    videoId:"oNUJek2xixA", videoChannel:"Chidi Nebo", videoTitle:"Crab Walk Exercise — Proper Form" },
  { id:"frog-jumps",       name:"Frog Jumps",                      tag:"Power + Cardio", sets:"3x8", rest:"60 s",
    ...
    videoId:"GvTeWVyJKNE", videoChannel:"Howcast", videoTitle:"Frog Jumps — Plyometric Exercise" },
  { id:"plank-jacks",      name:"Plank Jacks",                     tag:"Core + Cardio",  sets:"3x20 s", rest:"30 s",
    ...
    videoId:"8Do3ssZ23Mc", videoChannel:"Fitness For Transformation", videoTitle:"Plank Jacks — Proper Form" },
  { id:"speed-skaters",    name:"Speed Skaters",                   tag:"Lateral Power",  sets:"3x30 s", rest:"45 s",
    ...
    videoId:"9_jLW6VkU8A", videoChannel:"BuiltLean®", videoTitle:"Speed Skaters Exercise — Proper Form" },
  { id:"shuffle-sprint",   name:"Shuffle + Sprint Drill",          tag:"Basketball",     sets:"5 rounds", rest:"30 s",
    ...
    videoId:"zHirJs7syAI", videoChannel:"KP Sports Performance", videoTitle:"Shuffle + Sprint Drill" },
  { id:"quick-feet-cones", name:"Quick Feet Cone Drill",           tag:"Agility",        sets:"5 rounds", rest:"30 s",
    ...
    videoId:"OkOGTjWodHM", videoChannel:"TheUnGuardables", videoTitle:"Basketball Agility & Quickness Drills" },
  { id:"wall-sit",         name:"Wall Sit + Calf Raises",          tag:"Strength/Mental", sets:"3x30-45 s", rest:"45 s",
    ...
    videoId:"BLw3aPUi0k8", videoChannel:"The Movement Doc", videoTitle:"Wall Sit + Calf Raises" },
  { id:"jumping-jacks",    name:"Jumping Jacks",                   tag:"Warm-Up",        sets:"3x30 s", rest:"15 s",
    ...
    videoId:"c4DAnQ6DtF8", videoChannel:"FitnessBlender", videoTitle:"Jumping Jacks" },
  { id:"squat-jacks",      name:"Squat Jacks",                     tag:"Power + Cardio", sets:"3x15", rest:"45 s",
    ...
    videoId:"U4s4mEQ5VqU", videoChannel:"Howcast", videoTitle:"Squat Jacks Exercise" },
  { id:"push-shoulder-taps", name:"Push-Up Shoulder Taps",         tag:"Upper Body Core", sets:"3x10 each side", rest:"45 s",
    ...
    videoId:"kF9X6PKVysc", videoChannel:"Live Lean TV Daily Exercises", videoTitle:"Push-Up Shoulder Taps — Proper Form" },
];
...
const W_COORDINATION = [
  { id:"carioca",             name:"Carioca Drill",               tag:"Footwork",          sets:"3x20 yards", rest:"30 s",
    ...
    videoId:"R3__Q_SulyM", videoChannel:"Live Lean TV Daily Exercises", videoTitle:"Carioca Drill — Lateral Footwork" },
  { id:"lateral-carioca",     name:"Lateral Carioca",             tag:"Footwork",          sets:"3x15 yards each dir", rest:"30 s",
    ...
    videoId:"R3__Q_SulyM", videoChannel:"Live Lean TV Daily Exercises", videoTitle:"Lateral Carioca" },
  { id:"rhythm-line-hops",    name:"Rhythm Line Hops",            tag:"Rhythm",            sets:"3x20 s", rest:"30 s",
    ...
    videoId:"dJI2q9TPdig", videoChannel:"Jr. NBA Jr. WNBA", trusted:true, videoTitle:"Line Hops Drill — Jr. NBA at Home" },
  { id:"quick-step-matrix",   name:"Quick Step Matrix",           tag:"Multi-Direction",   sets:"3 rounds", rest:"45 s",
    ...
    videoId:"zt3_P2PyVco", videoChannel:"Coach Mike", videoTitle:"Lateral Step Matrix Footwork Drill" },
  { id:"sl-rhythm-hops",      name:"Single Leg Rhythm Hops",      tag:"Single Leg Coord",  sets:"3x12 each leg", rest:"30 s",
    ...
    videoId:"kehkiqjFQdw", videoChannel:"React Physical Therapy", videoTitle:"Single Leg Hop Agility Drill" },
  { id:"cross-body-toe-taps", name:"Cross Body Toe Taps",         tag:"Cross-Body",        sets:"3x20 s", rest:"20 s",
    ...
    videoId:"ZcFcjTON42I", videoChannel:"Christopher Johnson", videoTitle:"Cross Body Toe Taps" },
  { id:"reactive-cone-calls", name:"Reactive Cone Calls",         tag:"Reaction",          sets:"3x45 s", rest:"30 s",
    ...
    videoId:"LKLlDnisYZo", videoChannel:"Paul Easton Basketball", videoTitle:"Cone Reaction Drill" },
  { id:"partner-mirror",      name:"Partner Mirror Drill",        tag:"Reaction",          sets:"3x30 s", rest:"30 s",
    ...
    videoId:"yIPGMB-crog", videoChannel:"AvcssBasketball", trusted:true, videoTitle:"Youth Defensive Mirror Drill" },
  { id:"tennis-reaction-catch",name:"Tennis Ball Reaction Catch", tag:"Hand-Eye",          sets:"3x45 s", rest:"20 s",
    ...
    videoId:"kzn5mwP2J7c", videoChannel:"Teach Hoops", videoTitle:"Basketball Tennis Ball Reaction Drill" },
  { id:"alternating-line-hops",name:"Alternating Line Hops",     tag:"Rhythm",            sets:"3x20 s", rest:"20 s",
    ...
    videoId:"H0lpcLJ94dk", videoChannel:"Champion's QUEST", videoTitle:"Alternating Line Hops Agility Drill" },
  { id:"hip-flip-footwork",   name:"Hip Flip Footwork",          tag:"Hip Mobility",      sets:"3x10 each dir", rest:"30 s",
    ...
    videoId:"mZVvoGEuBIA", videoChannel:"ProTips4U", videoTitle:"Defensive Hip Flip — Basketball Drill" },
  { id:"fast-feet-turn",      name:"Fast Feet + Turn",           tag:"Quickness",         sets:"3x15 s", rest:"30 s",
    ...
    videoId:"z_WsDDyU258", videoChannel:"AvcssBasketball", trusted:true, videoTitle:"Fast Feet + Turn — Defensive Footwork Drill" },
  { id:"sl-snap-down-coord",  name:"Single Leg Snap Down",       tag:"Landing Coord",     sets:"3x8 each leg", rest:"45 s",
    ...
    videoId:"Wh4oGVLbewE", videoChannel:"Stan State Athletics", videoTitle:"Single Leg Snap Down — Landing Control" },
  { id:"lateral-step-matrix", name:"Lateral Step Matrix",        tag:"Multi-Direction",   sets:"3 rounds", rest:"45 s",
    ...
    videoId:"zt3_P2PyVco", videoChannel:"Coach Mike", videoTitle:"Lateral Step Matrix" },
  { id:"crossover-footwork",  name:"Crossover Footwork Patterns",tag:"Crossover",         sets:"3x each pattern", rest:"30 s",
    ...
    videoId:"btWfFkTUHog", videoChannel:"King Sports", videoTitle:"Crossover Run — Footwork Drill" },
];
...
const W_DECELERATION = [
  { id:"jump-stop-hold",       name:"Jump Stop Hold",            tag:"Landing",           sets:"3x8", rest:"45 s",
    ...
    videoId:"WjssoRn7GcU", videoChannel:"SPARC Physiotherapy", videoTitle:"Jump Stop — Two Foot Snap Down & Hold" },
  { id:"sl-stick-landing",     name:"Single Leg Stick Landing",  tag:"Single Leg",        sets:"3x8 each leg", rest:"45 s",
    ...
    videoId:"7WgzHOQGgYw", videoChannel:"Elevate Yourself", videoTitle:"Single Leg Stick Landing" },
  { id:"lateral-stick-landing",name:"Lateral Stick Landing",     tag:"Lateral",           sets:"3x8 each side", rest:"45 s",
    ...
    videoId:"AezzGLeOTss", videoChannel:"PJFPerformance", trusted:true, videoTitle:"Lateral Stick Landing" },
  { id:"drop-athletic-stance", name:"Drop To Athletic Stance",   tag:"Deceleration",      sets:"3x10", rest:"30 s",
    ...
    videoId:"WmcEiWGOiPg", videoChannel:"Sacrifice Training", videoTitle:"Reactive Landing Drill — Landing Mechanics" },
  { id:"sprint-to-stick",      name:"Sprint To Stick",           tag:"Deceleration",      sets:"3x5", rest:"60 s",
    ...
    videoId:"sdgPBkKNO4Y", videoChannel:"Brandon Smitley", videoTitle:"Sprint to Stick Landing — Deceleration" },
  { id:"decel-shuffle",        name:"Deceleration Shuffle",      tag:"Lateral Decel",     sets:"3x5 each dir", rest:"45 s",
    ...
    videoId:"ADDEtPq6c_s", videoChannel:"Vital Training Systems", videoTitle:"Lateral Shuffle — Deceleration Drill" },
  { id:"snap-down-to-hold",    name:"Snap Down To Hold",         tag:"Deceleration",      sets:"3x8", rest:"60 s",
    ...
    videoId:"_YudFDcW_Iw", videoChannel:"The Movement System", videoTitle:"Snap Down To Hold" },
  ...
  { id:"lateral-bound-stick",  name:"Lateral Bound Stick",       tag:"Lateral Power",     sets:"3x8 each side", rest:"60 s",
    ...
    videoId:"gjiZLF5S6aA", videoChannel:"Simple Speed Coach", videoTitle:"Lateral Bound Stick" },
  { id:"split-stance-absorb",  name:"Split Stance Absorption",   tag:"Staggered",         sets:"3x10", rest:"30 s",
    ...
    videoId:"f2-mg9EghpI", videoChannel:"Pro Source Athletics", videoTitle:"Hop Hop Stick — Plyometric Landing" },
  { id:"hop-hop-stick",        name:"Hop-Hop-Stick",             tag:"Reactive Landing",  sets:"3x6 each leg", rest:"45 s",
    ...
    videoId:"f2-mg9EghpI", videoChannel:"Pro Source Athletics", videoTitle:"Hop-Hop-Stick" },
  { id:"reactive-landing",     name:"Reactive Landing Drill",    tag:"Reactive",          sets:"3x8", rest:"45 s",
    ...
    videoId:"WmcEiWGOiPg", videoChannel:"Sacrifice Training", videoTitle:"Reactive Landing Drill" },
  ...
  { id:"depth-landing-hold",   name:"Depth Landing Hold",        tag:"Depth",             sets:"3x6", rest:"60 s",
    ...
    videoId:"WmcEiWGOiPg", videoChannel:"Sacrifice Training", videoTitle:"Depth Landing Hold — Landing Mechanics" },
  { id:"closeout-decel",       name:"Closeout Deceleration",     tag:"Basketball",        sets:"3x8", rest:"45 s",
    ...
    videoId:"6mzS2sVhcdg", videoChannel:"Jr. NBA Jr. WNBA", trusted:true, videoTitle:"Closeout Deceleration — Basketball Defense" },
];
...
const W_ATHLETIC = [
  { id:"hip-turns",            name:"Hip Turns",                 tag:"Hip Mobility",      sets:"3x10 each dir", rest:"30 s",
    ...
    trainer:"Brian McCormick", videoId:"q5z-WcLbCso", videoChannel:"Brian McCormick", trusted:true, videoTitle:"Hip Turn & Drop Step — Defensive Footwork" },
  { id:"defensive-hip-flip",   name:"Defensive Hip Flip",        tag:"Defense",           sets:"3x10 each dir", rest:"30 s",
    ...
    videoId:"mZVvoGEuBIA", videoChannel:"ProTips4U", videoTitle:"Defensive Hip Flip" },
  { id:"retreat-sprint",       name:"Retreat Sprint",            tag:"Backpedal",         sets:"3x5", rest:"45 s",
    ...
    videoId:"zj5ReqFvKEQ", videoChannel:"ATTACKBball", videoTitle:"Retreat Sprint — Defensive Footwork Drill" },
  { id:"closeout-footwork",    name:"Closeout Footwork",         tag:"Defense",           sets:"3x8", rest:"30 s",
    ...
    videoId:"aXGENfO9lPg", videoChannel:"Better Basketball Training (Ozswoosh)", videoTitle:"Closeout Footwork — Basketball Defense" },
  { id:"shuffle-shuffle-sprint",name:"Shuffle Shuffle Sprint",   tag:"Transition",        sets:"5 rounds", rest:"30 s",
    ...
    videoId:"zHirJs7syAI", videoChannel:"KP Sports Performance", videoTitle:"Shuffle Shuffle Sprint" },
  { id:"backpedal-sprint",     name:"Backpedal To Sprint",       tag:"Transition",        sets:"3x5", rest:"45 s",
    ...
    videoId:"vYnnIZZ91fI", videoChannel:"Basketball Coach Allen", videoTitle:"Defensive Recovery Run — Reaction Drill" },
  { id:"sprint-float-sprint",  name:"Sprint Float Sprint",       tag:"Speed Variation",   sets:"3x1", rest:"60 s",
    ...
    videoId:"qF88X_wLGlg", videoChannel:"Simple Speed Coach", videoTitle:"Sprint Float Sprint — Speed Variation" },
  { id:"reactive-slide",       name:"Reactive Slide Drill",      tag:"Defense",           sets:"3x30 s", rest:"30 s",
    ...
    videoId:"XDhHu6YxmFo", videoChannel:"Kbands Training", videoTitle:"Reactive Slide — Defensive Shuffle Drill" },
  { id:"crossover-run",        name:"Crossover Run",             tag:"Footwork",          sets:"3x20 yards", rest:"30 s",
    ...
    videoId:"btWfFkTUHog", videoChannel:"King Sports", videoTitle:"Crossover Run" },
  { id:"acceleration-starts",  name:"Acceleration Starts",       tag:"Speed",             sets:"5x10 yards", rest:"45 s",
    ...
    videoId:"bIsKXTp3nA0", videoChannel:"Howcast", videoTitle:"Sprinter Acceleration Drills" },
  { id:"three-step-burst",     name:"3-Step Burst",              tag:"Explosion",         sets:"3x8 each dir", rest:"30 s",
    ...
    videoId:"0aFbY3lg2kw", videoChannel:"Matt Tometz", videoTitle:"3-Step Burst — Sprint Acceleration Drill" },
  { id:"drop-step-sprint",     name:"Drop Step Sprint",          tag:"Transition",        sets:"3x5 each side", rest:"30 s",
    ...
    videoId:"XXjV6wYmQKE", videoChannel:"Jr. NBA Jr. WNBA", trusted:true, videoTitle:"Drop Step Sprint — Basketball Transition" },
  { id:"defensive-recovery",   name:"Defensive Recovery Run",    tag:"Defense",           sets:"3x full court", rest:"60 s",
    ...
    videoId:"vYnnIZZ91fI", videoChannel:"Basketball Coach Allen", videoTitle:"Defensive Recovery Run" },
  { id:"lateral-sprint-combo", name:"Lateral Sprint Combo",      tag:"Multi-Direction",   sets:"4 rounds", rest:"45 s",
    ...
    videoId:"rrImTQmO31E", videoChannel:"adidas", videoTitle:"Lateral Sprint Combo" },
  { id:"reaction-sprint",      name:"Reaction Sprint Drill",     tag:"Reactive",          sets:"5 rounds", rest:"30 s",
    ...
    videoId:"CmisKok_aiI", videoChannel:"Simple Speed Coach", videoTitle:"The X-Drill — Reaction & Agility" },
];
...
const W_SHOOTING = [
  { id:"sackmann-range", name:"Extend Your Shooting Range",       tag:"DJ Sackmann",
    ...
    trainer:"DJ Sackmann · HoopStudy", videoId:"aJLFNkb7QA4", videoChannel:"HoopStudy", trusted:true, videoTitle:"Extend Your Shooting Range — DJ Sackmann" },
  { id:"relph-5spot",    name:"5-Spot Make Drill",                 tag:"Tyler Relph",
    ...
    trainer:"Tyler Relph · Hoop Dynamic", videoId:"qwhx3s8LVnA", videoChannel:"Tyler Relph's Hoop Dynamic", trusted:true, videoTitle:"5 Spot Shooting Drill — Tyler Relph" },
  { id:"relph-42pt",     name:"42-Point Shooting Competition",     tag:"Tyler Relph",
    ...
    trainer:"Tyler Relph · Hoop Dynamic", videoId:"X9PMRvGxelc", videoChannel:"Tyler Relph's Hoop Dynamic", trusted:true, videoTitle:"42-Point Shooting Competition — Tyler Relph" },
  { id:"sackmann-hesi-shot", name:"Shoot Out of Hesitations",     tag:"DJ Sackmann",
    ...
    trainer:"Shot Science Basketball", videoId:"EyYbMJzrKYs", videoChannel:"Shot Science Basketball", trusted:true, videoTitle:"Hesitation Dribble Attack" },
  ...
  { id:"chal-timed-3pt", name:"Timed 3-Point Challenge",         tag:"3-Point Challenge",
    ...
    trainer:"Coach Tony Miller", videoId:"5t1bSN9bxeI", videoChannel:"Coach Tony Miller", videoTitle:"Competitive Shooting Challenge — Coach Tony Miller" },
  ...
  { id:"chal-5spot-mid", name:"5-Spot Test — Mid-Range",         tag:"5-Spot Challenge",
    ...
    trainer:"Dr. Dish Basketball", videoId:"cuud1564_lM", videoChannel:"Dr. Dish Basketball", videoTitle:"5-Spot Shooting Challenge — Dr. Dish" },
  ...
  { id:"chal-5spot-3pt", name:"5-Spot Test — 3-Point",           tag:"5-Spot Challenge",
    ...
    trainer:"Teach Hoops", videoId:"iI479qqfSFw", videoChannel:"Teach Hoops", videoTitle:"5-Spot Shooting Drill — Teach Hoops" },
  ...
  { id:"chal-atw-3pt",   name:"Around the World (3s)",           tag:"3-Point Challenge",
    ...
    trainer:"Shoot-A-Way", videoId:"_ThYnVrVCYE", videoChannel:"Shoot-A-Way", trusted:true, videoTitle:"2-in-a-Row Around the World — Shoot-A-Way" },
  ...
  { id:"chal-beal-5spot", name:"Bradley Beal 5-Spot (2-Up-2-Back)", tag:"Bradley Beal",
    ...
    trainer:"Patrick Schnell", videoId:"PGdn1j3uNL4", videoChannel:"Patrick Schnell", videoTitle:"1-Minute Bradley Beal Shooting Drill" },
];
...
const W_BALL_HANDLING = [
  { id:"bh-pound",        name:"Pound Dribble",           tag:"Foundation",      difficulty:"beginner",     ageRange:[9,14],  funScore:5,  estimatedDuration:90,
    ...
    trainer:"Pure Sweat Basketball", videoId:"xaOeh5CEc68", videoChannel:"Pro Skills Basketball", videoTitle:"Pound Dribbles — Pure Sweat Basketball" },
  ...
  { id:"bh-crossover",    name:"Crossovers",              tag:"Basic Moves",     difficulty:"beginner",     ageRange:[9,14],  funScore:8,  estimatedDuration:90,
    ...
    trainer:"Kids Basketball Training", videoId:"7kFuB5Wc970", videoChannel:"Kids Basketball Training", trusted:true, videoTitle:"How To Crossover For Beginners" },
  ...
  { id:"bh-btl",          name:"Between Legs",            tag:"Intermediate",    difficulty:"intermediate", ageRange:[10,14], funScore:9,  estimatedDuration:90,
    ...
    trainer:"Cramer Basketball", videoId:"Y7PjqLcIhXw", videoChannel:"HandleLife", videoTitle:"Between Your Legs Dribble — Cramer Basketball" },
  ...
  { id:"bh-in-out",       name:"In & Out Dribble",        tag:"Basic Moves",     difficulty:"beginner",     ageRange:[9,14],  funScore:7,  estimatedDuration:90,
    ...
    trainer:"Cramer Basketball", videoId:"LMy9MUEd0Q0", videoChannel:"Cramer Basketball", trusted:true, videoTitle:"V Dribble Series — Cramer Basketball" },
  ...
  { id:"bh-retreat",      name:"Retreat Dribble",         tag:"Intermediate",    difficulty:"intermediate", ageRange:[10,14], funScore:7,  estimatedDuration:90,
    ...
    trainer:"Jr. NBA", videoId:"LY31S_8yyOA", videoChannel:"Jr. NBA Jr. WNBA", trusted:true, videoTitle:"Fundamentals of the Retreat Dribble" },
  ...
  { id:"bh-attack-cross", name:"Attack Cross",            tag:"Advanced Moves",  difficulty:"intermediate", ageRange:[10,14], funScore:10, estimatedDuration:120,
    ...
    trainer:"ShotMechanics", videoId:"WokdWEYZ7GU", videoChannel:"ShotMechanics", trusted:true, videoTitle:"Kyrie Irving Dribbling Drills — ShotMechanics" },
  ...
  { id:"bh-combo",        name:"Combo Series",            tag:"Advanced Moves",  difficulty:"advanced",     ageRange:[11,14], funScore:10, estimatedDuration:120,
    ...
    trainer:"Pro Skills Basketball", videoId:"xyZNJoctA9w", videoChannel:"Better Basketball Training (Ozswoosh)", videoTitle:"Best Fun Youth Basketball Drill — Improve Dribbling" },
];
...
const W_FOOTWORK = [
  { id:"fw-jump-stop",    name:"Jump Stop",               tag:"Foundation",      difficulty:"beginner",     ageRange:[9,14],  funScore:5,  estimatedDuration:90,
    ...
    trainer:"Jr. NBA", videoId:"jgqdv9ySjYM", videoChannel:"Jr. NBA Jr. WNBA", trusted:true, videoTitle:"Jump Stop, Pivot & Pass Drill — Jr. NBA" },
  ...
  { id:"fw-front-pivot",  name:"Front Pivot",             tag:"Foundation",      difficulty:"beginner",     ageRange:[9,14],  funScore:5,  estimatedDuration:60,
    ...
    trainer:"Jr. NBA", videoId:"3GPNfqIzs9Y", videoChannel:"Jr. NBA Jr. WNBA", trusted:true, videoTitle:"Forward Pivot Drill — Jr. NBA" },
  ...
  { id:"fw-rev-pivot",    name:"Reverse Pivot",           tag:"Intermediate",    difficulty:"intermediate", ageRange:[10,14], funScore:6,  estimatedDuration:60,
    ...
    trainer:"Jr. NBA", videoId:"5DgXrx7ZkHU", videoChannel:"Jr. NBA Jr. WNBA", trusted:true, videoTitle:"Reverse Pivot Drill — Jr. NBA" },
  ...
  { id:"fw-triple-threat", name:"Triple Threat",          tag:"Foundation",      difficulty:"beginner",     ageRange:[9,14],  funScore:5,  estimatedDuration:60,
    ...
    trainer:"Cramer Basketball", videoId:"dg9y9-PuQNE", videoChannel:"Cramer Basketball", trusted:true, videoTitle:"Triple Threat Combo Shot Fake Jab Step — Cramer Basketball" },
  ...
  { id:"fw-jab-series",   name:"Jab Step Series",         tag:"Intermediate",    difficulty:"intermediate", ageRange:[10,14], funScore:8,  estimatedDuration:90,
    ...
    trainer:"ShotMechanics", videoId:"eE2Vp10Sqko", videoChannel:"ShotMechanics", trusted:true, videoTitle:"Stephen Curry Jab Step Back Move — ShotMechanics" },
  ...
  { id:"fw-rip-through",  name:"Rip Through",             tag:"Intermediate",    difficulty:"intermediate", ageRange:[10,14], funScore:7,  estimatedDuration:90,
    ...
    trainer:"Teach Hoops", videoId:"7dxMH7aP6_Y", videoChannel:"Teach Hoops", videoTitle:"Rip Through & Drive — Great Basketball Moves" },
  ...
  { id:"fw-sweep-go",     name:"Sweep & Go",              tag:"Intermediate",    difficulty:"intermediate", ageRange:[10,14], funScore:7,  estimatedDuration:90,
    ...
    trainer:"Basketball HQ", videoId:"gzdweY9uYA8", videoChannel:"eBasketballCoach", videoTitle:"1 Minute Basketball Drills: Sweep and Go" },
  ...
  { id:"fw-shot-fake",    name:"Shot Fake Series",         tag:"Advanced",        difficulty:"intermediate", ageRange:[10,14], funScore:9,  estimatedDuration:90,
    ...
    trainer:"Basketball HQ", videoId:"CGnkzd9wV6g", videoChannel:"Baller Boot Camp", videoTitle:"How To Use The Shot Fake To Score More Points In Basketball" },
];
...
const W_FINISHING = [
  { id:"fin-mikan",       name:"Mikan Drill",             tag:"Foundation",      difficulty:"beginner",     ageRange:[9,14],  funScore:9,  estimatedDuration:120,
    ...
    trainer:"Pro Skills Basketball", videoId:"3ZVV7aN1F-A", videoChannel:"Pro Skills Basketball", videoTitle:"PSB Drills & Skills — Mikan Drill" },
  ...
  { id:"fin-rev-mikan",   name:"Reverse Mikan",           tag:"Intermediate",    difficulty:"intermediate", ageRange:[10,14], funScore:8,  estimatedDuration:120,
    ...
    trainer:"CoachMcGannon", videoId:"RZCwpSgNeXo", videoChannel:"CoachMcGannon", videoTitle:"The Reverse Mikan Drill" },
  ...
  { id:"fin-power-layup", name:"Power Layups",            tag:"Foundation",      difficulty:"beginner",     ageRange:[9,14],  funScore:7,  estimatedDuration:90,
    ...
    trainer:"Baller Bootcamp", videoId:"treZvJON-xM", videoChannel:"Baller Boot Camp", videoTitle:"How To Shoot A Power Layup In Basketball" },
  ...
  { id:"fin-reverse",     name:"Reverse Layups",          tag:"Intermediate",    difficulty:"intermediate", ageRange:[10,14], funScore:8,  estimatedDuration:90,
    ...
    trainer:"Get Handles Basketball", videoId:"OUO94jaAvz4", videoChannel:"Get Handles Basketball", trusted:true, videoTitle:"How To Reverse Layups For Beginners — Get Handles" },
  ...
  { id:"fin-floater",     name:"Floater Series",          tag:"Advanced",        difficulty:"advanced",     ageRange:[11,14], funScore:9,  estimatedDuration:120,
    ...
    trainer:"ShotMechanics", videoId:"FtT0iQsl890", videoChannel:"ShotMechanics", trusted:true, videoTitle:"Floater Secrets — 3 Simple Keys to Scoring the Floater" },
  ...
  { id:"fin-euro",        name:"Euro Step",               tag:"Advanced",        difficulty:"intermediate", ageRange:[10,14], funScore:10, estimatedDuration:120,
    ...
    trainer:"ShotMechanics", videoId:"-7ONK1hiZ2A", videoChannel:"ShotMechanics", trusted:true, videoTitle:"How To Euro Step The Safe Way — ShotMechanics" },
  ...
  { id:"fin-pro-hop",     name:"Pro Hop Finish",          tag:"Advanced",        difficulty:"advanced",     ageRange:[11,14], funScore:9,  estimatedDuration:120,
    ...
    trainer:"ShotMechanics", videoId:"pt4i4fzXcSk", videoChannel:"Cramer Basketball", trusted:true, videoTitle:"How to Pro Hop Basketball Moves — ShotMechanics" },
  ...
  { id:"fin-wrong-foot",  name:"Wrong Foot Layup",        tag:"Elite",           difficulty:"advanced",     ageRange:[11,14], funScore:9,  estimatedDuration:120,
    ...
    trainer:"GetHandles", videoId:"vIfDkyZf52s", videoChannel:"Get Handles Basketball", trusted:true, videoTitle:"Why You SHOULD Take Wrong Foot Layups — GetHandles" },
];
...
const W_SHOOTING_DRILLS = [
  { id:"sh-form",         name:"Form Shooting",           tag:"Foundation",      difficulty:"beginner",     ageRange:[9,14],  funScore:5,  estimatedDuration:300,
    ...
    trainer:"CoachUp", videoId:"E4O2JeAYg5Q", videoChannel:"CoachUp", videoTitle:"The Form Shooting Drill" },
  ...
  { id:"sh-one-hand",     name:"One Hand Form Shooting",  tag:"Foundation",      difficulty:"intermediate", ageRange:[10,14], funScore:5,  estimatedDuration:180,
    ...
    trainer:"Pro Skills Basketball", videoId:"drjHBtMgbF4", videoChannel:"Pro Skills Basketball", videoTitle:"One Hand Form Shot — PSB Drills & Skills" },
  ...
  { id:"sh-spot",         name:"Spot Shooting",           tag:"Volume",          difficulty:"intermediate", ageRange:[10,14], funScore:8,  estimatedDuration:600,
    ...
    trainer:"Basketball Drills", videoId:"1RQPTBFduwc", videoChannel:"PGC Coaching", videoTitle:"7 Spot Basketball Shooting Drill" },
  ...
  { id:"sh-atw",          name:"Around The World",        tag:"Game",            difficulty:"beginner",     ageRange:[9,14],  funScore:10, estimatedDuration:300,
    ...
    trainer:"Teach Hoops", videoId:"KCJHGqWZRLU", videoChannel:"Teach Hoops", videoTitle:"Around the World Basketball Shooting Drill — Teach Hoops" },
  ...
  { id:"sh-ft-routine",   name:"Free Throw Routine",      tag:"Foundation",      difficulty:"beginner",     ageRange:[9,14],  funScore:5,  estimatedDuration:300,
    ...
    trainer:"PGC Basketball", videoId:"0kj_B1za0U0", videoChannel:"PGC Basketball - Point Guard College", trusted:true, videoTitle:"Make More Free Throws — PGC Basketball" },
  ...
  { id:"sh-beat-pro",     name:"Beat The Pro",            tag:"Game",            difficulty:"intermediate", ageRange:[10,14], funScore:10, estimatedDuration:300,
    ...
    trainer:"PGC Basketball", videoId:"LlPdpW6l1SQ", videoChannel:"PGC Basketball - Point Guard College", trusted:true, videoTitle:"Beat the Pro — PGC Basketball" },
  ...
  { id:"sh-knee-roll",    name:"Knee Roll Ups",              tag:"Foundation",      difficulty:"beginner",     ageRange:[9,14],  funScore:6,  estimatedDuration:120,
    ...
    trainer:"Basketball Immersion", videoId:"cpWL5s5XG0g", videoChannel:"Basketball Immersion", trusted:true, videoTitle:"Roll Ups — Beyond Static Form Shooting Drills" },
  ...
  { id:"sh-hop-shot",     name:"2 Hop Shots",                tag:"Foundation",      difficulty:"beginner",     ageRange:[9,14],  funScore:7,  estimatedDuration:120,
    ...
    trainer:"HoopsKing", videoId:"uxkg9NJfBFo", videoChannel:"HoopsKing.com Basketball & Vertical Jump Training", videoTitle:"1-2 Step vs. Hop Step Shooting Footwork" },
  ...
  { id:"sb-hop-shoot",    name:"Hop Back Balance Shot",       tag:"Foundation",      difficulty:"beginner",     ageRange:[9,14],  funScore:7,  estimatedDuration:120,
    ...
    trainer:"ShotMechanics", videoId:"RD0tviQ3dh4", videoChannel:"ShotMechanics", trusted:true, videoTitle:"One Foot Balance Shooting Drill" },
  ...
  { id:"sb-dribble-step", name:"Dribble Step-Back",           tag:"Intermediate",    difficulty:"intermediate", ageRange:[10,14], funScore:8,  estimatedDuration:120,
    ...
    trainer:"Jr. NBA", videoId:"fFL-PugpRS8", videoChannel:"Jr. NBA Jr. WNBA", trusted:true, videoTitle:"Elena Delle Donne Teaches the Step-Back" },
  ...
  { id:"sb-drive-step",   name:"Drive-to Step-Back",          tag:"Advanced",        difficulty:"advanced",     ageRange:[11,14], funScore:9,  estimatedDuration:120,
    ...
    trainer:"ILoveBasketballTV", videoId:"eE2Vp10Sqko", videoChannel:"ShotMechanics", trusted:true, videoTitle:"How to Shoot a Step Back Jumper — ILoveBasketballTV" },
  ...
  { id:"sh-jab-reset",    name:"Jab Step Reset & Shoot",     tag:"Game",            difficulty:"intermediate", ageRange:[10,14], funScore:9,  estimatedDuration:120,
    ...
    trainer:"Ryan Razooky", videoId:"bmUmNPRfrWo", videoChannel:"Dr. Dish Basketball", videoTitle:"Basketball Shooting Drills: Jab Step Series — Ryan Razooky" },
];
...
const W_POST_MOVES = [
  { id:"pm-seal",        name:"Post Seal & Get Position",      tag:"Foundation",      difficulty:"beginner",     ageRange:[9,14],  funScore:6,  estimatedDuration:150,
    ...
    trainer:"Shot Science Basketball", videoId:"t2dJ6EpQIgk", videoChannel:"Shot Science Basketball", trusted:true, videoTitle:"Sealing in the Post (Like Shaq and Yao Ming) — Shot Science Basketball" },
  ...
  { id:"pm-drop-step",   name:"Drop Step",                     tag:"Foundation",      difficulty:"beginner",     ageRange:[9,14],  funScore:8,  estimatedDuration:150,
    ...
    trainer:"Howcast", videoId:"kcwCvwCBU-A", videoChannel:"Howcast", videoTitle:"How to Do a Drop-Step | Basketball Moves — Howcast" },
  ...
  { id:"pm-hook",        name:"Jump Hook Shot",                 tag:"Foundation",      difficulty:"beginner",     ageRange:[9,14],  funScore:8,  estimatedDuration:150,
    ...
    trainer:"Shot Science Basketball", videoId:"Oq2V-7cv0R4", videoChannel:"Shot Science Basketball", trusted:true, videoTitle:"JUMP HOOK Basketball Shot! Low Post Move Tutorial — Shot Science Basketball" },
  ...
  { id:"pm-up-under",    name:"Up and Under",                  tag:"Intermediate",    difficulty:"intermediate", ageRange:[10,14], funScore:9,  estimatedDuration:150,
    ...
    trainer:"Grizzlies Youth Basketball", videoId:"PIqvdG1HpoA", videoChannel:"Grizzlies Youth Basketball", videoTitle:"Master The Up & Under Post Move — Grizzlies Youth Basketball" },
  ...
  { id:"pm-spin",        name:"Post Spin Move",                 tag:"Intermediate",    difficulty:"intermediate", ageRange:[10,14], funScore:9,  estimatedDuration:150,
    ...
    trainer:"ShotMechanics", videoId:"Ug3uvtnC8KI", videoChannel:"ShotMechanics", trusted:true, videoTitle:"How To Perfect the Spin Move: Basketball Moves Mastery — ShotMechanics" },
  ...
  { id:"pm-face-up",     name:"Face-Up from the Post",         tag:"Intermediate",    difficulty:"intermediate", ageRange:[10,14], funScore:8,  estimatedDuration:150,
    ...
    trainer:"IMG Academy", videoId:"bfmADWVQp3o", videoChannel:"IMG Academy", videoTitle:"Facing Up — Post Offensive Skills" },
  ...
  { id:"pm-step-through", name:"Shot Fake & Step Through",     tag:"Game",            difficulty:"intermediate", ageRange:[10,14], funScore:9,  estimatedDuration:120,
    ...
    trainer:"ShotMechanics", videoId:"Y36J42YAaMg", videoChannel:"ShotMechanics", trusted:true, videoTitle:"Step Through Post Move (LeBron James)" },
  ...
  { id:"pm-saddi-combo",  name:"Post Moves Combo (Saddi Washington)", tag:"Game",     difficulty:"intermediate", ageRange:[10,14], funScore:10, estimatedDuration:180,
    ...
    trainer:"Saddi Washington / My Basketball", videoId:"GOqBvniupY4", videoChannel:"My Basketall", videoTitle:"Post Moves with Saddi Washington — Univ. of Michigan" },
];
...
const W_FINISHING_SCHOOL = [
  { id:"fs-power-finish",  name:"Two-Foot Power Finish",      tag:"Foundation",  difficulty:"beginner",     ageRange:[9,14],  funScore:7,  estimatedDuration:90,
    ...
    trainer:"TeachHoops", videoId:"YzSXr6uNNVQ", videoChannel:"Coach Ashworth", videoTitle:"Basketball Drill for Better Layups - Play Off Two Feet" },
  ...
  { id:"fs-hop-step",      name:"Hop Step (Pro Hop)",          tag:"Intermediate",difficulty:"intermediate", ageRange:[10,14], funScore:9,  estimatedDuration:120,
    ...
    trainer:"TeachHoops", videoId:"p88Tll8I_Tk", videoChannel:"Teach Hoops", videoTitle:"Step-Hop to Layup: Basketball Finishing Drill" },
  ...
  { id:"fs-contact-finish",name:"Finish Through Contact",      tag:"Advanced",    difficulty:"advanced",     ageRange:[11,14], funScore:8,  estimatedDuration:120,
    ...
    trainer:"Breakthrough Basketball", videoId:"6lyBb7u7SAg", videoChannel:"BreakthroughBBall", videoTitle:"1v1 Finishing Drill From The Corner" },
  ...
  { id:"fs-low-pickup",    name:"Low Pickup Finish",           tag:"Advanced",    difficulty:"advanced",     ageRange:[11,14], funScore:9,  estimatedDuration:120,
    ...
    trainer:"ILoveBasketball", videoId:"xyKHAcLPWqc", videoChannel:"ILoveBasketballTV", trusted:true, videoTitle:"Dribble Pickups Impossible to Guard — ILoveBasketball" },
  ...
  { id:"fs-speed-gather",  name:"Speed Gather (One Foot)",     tag:"Foundation",  difficulty:"intermediate", ageRange:[10,14], funScore:8,  estimatedDuration:90,
    ...
    trainer:"PJF Performance", videoId:"B444HaiZPkE", videoChannel:"PJFPerformance", trusted:true, videoTitle:"7 Types of Finishing Footwork for Layups" },
  ...
  { id:"relph-scoop",    name:"Scoop Layups",                    tag:"Advanced",    difficulty:"intermediate", ageRange:[10,14], funScore:7,  estimatedDuration:120,
    ...
    trainer:"Tyler Relph · Hoop Dynamic", videoId:"J3RYUety18M", videoChannel:"Tyler Relph's Hoop Dynamic", trusted:true, videoTitle:"Scoop Layups — Tyler Relph Hoop Dynamic" },
  ...
  { id:"sackmann-finish", name:"Footwork and Finishes",          tag:"Advanced",    difficulty:"intermediate", ageRange:[10,14], funScore:7,  estimatedDuration:180,
    ...
    trainer:"Jr. NBA", videoId:"QSzapEqhOaE", videoChannel:"Jr. NBA Jr. WNBA", trusted:true, videoTitle:"V-Cut Layup Drill" },
...
const W_FOOTWORK_LAB = [
  { id:"flab-triple-threat",name:"Triple Threat + Jab",        tag:"Foundation",  difficulty:"beginner",     ageRange:[9,14],  funScore:6,  estimatedDuration:90,
    ...
    trainer:"Baller Boot Camp", videoId:"pjV78JTtqI0", videoChannel:"Baller Boot Camp", videoTitle:"Basketball Fundamentals and Tips - How To Triple Threat | Jab Step | Footwork | Offense" },
  ...
  { id:"flab-jab-series",  name:"Full Jab Step Series",        tag:"Intermediate",difficulty:"intermediate", ageRange:[10,14], funScore:8,  estimatedDuration:90,
    ...
    trainer:"Basketball HQ", videoId:"IZWZIIiqQ-4", videoChannel:"Paul Easton Basketball", videoTitle:"Basketball Footwork - Jab Series" },
  ...
  { id:"flab-shot-fake",   name:"Shot Fake + 1-Dribble Pull-Up",tag:"Intermediate",difficulty:"intermediate", ageRange:[10,14], funScore:9,  estimatedDuration:90,
    ...
    trainer:"Jr. NBA feat. C.J. McCollum", videoId:"Auzwv0cDHIc", videoChannel:"Jr. NBA Jr. WNBA", trusted:true, videoTitle:"The Shot Fake 1-Dribble Pull-Up Drill" },
  ...
  { id:"flab-step-through", name:"Step-Through Move",           tag:"Intermediate",difficulty:"intermediate", ageRange:[10,14], funScore:8,  estimatedDuration:90,
    ...
    trainer:"ILoveBasketball", videoId:"J-sGu1b3zcg", videoChannel:"ILoveBasketballTV", trusted:true, videoTitle:"Step-Through Move Variations — ILoveBasketball" },
  ...
  { id:"flab-duck-in",     name:"Duck-In & Seal",               tag:"Intermediate",difficulty:"intermediate", ageRange:[10,14], funScore:7,  estimatedDuration:120,
    ...
    trainer:"Pro Tips by DICK'S Sporting Goods", videoId:"dTzfpwqW8Yo", videoChannel:"DICK'S", videoTitle:"The Fundamentals of the Duck In and Seal" },
  ...
  { id:"flab-rocker-step", name:"Rocker Step",                   tag:"Advanced",    difficulty:"intermediate", ageRange:[11,14], funScore:8,  estimatedDuration:90,
    ...
    trainer:"Pro Training Basketball", videoId:"NbOqnSj6lN8", videoChannel:"Coach Frikki", videoTitle:"Rocker Step - Shiftiest Move Ever (Footwork Mastery)" },
  ...
  { id:"sackmann-footwork", name:"Footwork Foundation",           tag:"Intermediate",difficulty:"intermediate", ageRange:[10,14], funScore:6,  estimatedDuration:180,
    ...
    trainer:"DJ Sackmann · HoopStudy", videoId:"Y3RZTBlAT_E", videoChannel:"The Hoop Group", videoTitle:"Basketball Footwork Focus — DJ Sackmann" },
];
...
const W_GAME_HANDLES = [
  { id:"gh-stationary-cross",name:"Stationary Crossover",      tag:"Foundation",  difficulty:"beginner",     ageRange:[9,14],  funScore:7,  estimatedDuration:90,
    ...
    trainer:"Jr. NBA", videoId:"fuCNf4nmDpM", videoChannel:"Jr. NBA Jr. WNBA", trusted:true, videoTitle:"Stationary Crossover Drill" },
  ...
  { id:"gh-change-pace",   name:"Change-of-Pace Dribble",      tag:"Foundation",  difficulty:"beginner",     ageRange:[9,14],  funScore:8,  estimatedDuration:90,
    ...
    trainer:"Howcast", videoId:"0Wwv5nDpL6k", videoChannel:"Howcast", videoTitle:"How to Do a Change-of-Pace Dribble | Basketball Moves" },
  ...
  { id:"gh-cross-btl",     name:"Crossover + Between-the-Legs",tag:"Foundation",  difficulty:"beginner",     ageRange:[9,14],  funScore:8,  estimatedDuration:90,
    ...
    trainer:"Hawks Basketball Academy", videoId:"h7s31K0kPh4", videoChannel:"Atlanta Hawks", videoTitle:"Stationary Crossover & Between the Legs (Beginner Dribble Moves)" },
  ...
  { id:"gh-behind-back",   name:"Behind-the-Back Dribble",     tag:"Intermediate",difficulty:"intermediate", ageRange:[10,14], funScore:9,  estimatedDuration:90,
    ...
    trainer:"Jr. NBA", videoId:"cGQ7dXW0jCA", videoChannel:"Jr. NBA Jr. WNBA", trusted:true, videoTitle:"Behind The Back Wrap Breakdown Drill" },
  ...
  { id:"gh-dribble-drive", name:"Dribble-Drive Attack",         tag:"Advanced",    difficulty:"intermediate", ageRange:[11,14], funScore:9,  estimatedDuration:90,
    ...
    trainer:"General Coaching", videoId:"w7Vkpj88edI", videoChannel:"Basketball Coach Allen", videoTitle:"Dribble Drive Attack Basketball Drill" },
  ...
  { id:"gethandles-combo", name:"Combo Crossover — Beat Defenders", tag:"Advanced",    difficulty:"advanced",     ageRange:[11,14], funScore:7,  estimatedDuration:180,
    ...
    trainer:"Get Handles · Jesse Muench", videoId:"i1bQI_esIIw", videoChannel:"Get Handles Basketball", trusted:true, videoTitle:"Combo Crossover Beat Defenders — Get Handles" },
  ...
  { id:"gh-in-out",        name:"In-and-Out",                 tag:"Rhythm Move", difficulty:"beginner",     ageRange:[9,14],  funScore:8,  estimatedDuration:90,
    ...
    trainer:"KaKaBasketball", videoId:"dF61fgRPa3g", videoChannel:"KaKaBasketball", videoTitle:"In-and-Out Dribble — Basketball Basics" },
  ...
  { id:"gh-stutter",       name:"Stutter Dribble",            tag:"Rhythm Move", difficulty:"beginner",     ageRange:[9,14],  funScore:8,  estimatedDuration:90,
    ...
    trainer:"AvcssBasketball", videoId:"06a9mc2gThU", videoChannel:"AvcssBasketball", trusted:true, videoTitle:"Stutter Step Dribbling for Youth — Avcss" },
  ...
  { id:"gh-freeze",        name:"Freeze / Dead Leg",          tag:"Rhythm Move", difficulty:"advanced",     ageRange:[11,14], funScore:8,  estimatedDuration:90,
    ...
    trainer:"Get Handles Basketball", videoId:"XvQFAjvRtwI", videoChannel:"Get Handles Basketball", trusted:true, videoTitle:"Freeze Dribble — Get Handles" },
  ...
  { id:"gh-push-cross",    name:"Push Crossover",             tag:"Attack Move", difficulty:"intermediate", ageRange:[10,14], funScore:8,  estimatedDuration:90,
    ...
    trainer:"Get Handles Basketball", videoId:"xACPHCWdbSU", videoChannel:"Get Handles Basketball", trusted:true, videoTitle:"How to Push Cross — Get Handles" },
  ...
  { id:"gh-half-spin",     name:"Half-Spin (Spin & Go)",      tag:"Counter",     difficulty:"advanced",     ageRange:[10,14], funScore:9,  estimatedDuration:90,
    ...
    trainer:"Get Handles Basketball", videoId:"R-NdxJLMPLw", videoChannel:"Get Handles Basketball", trusted:true, videoTitle:"Spin Move Drills (Beginner & Advanced) — Get Handles" },
  ...
  { id:"gh-shamgod",       name:"Shamgod",                    tag:"Advanced Move",difficulty:"advanced",    ageRange:[11,14], funScore:10, estimatedDuration:120,
    ...
    trainer:"HandleLife", videoId:"BLK9vmk9csk", videoChannel:"HandleLife", videoTitle:"How To Do The Shammgod — HandleLife" },
  ...
  { id:"gh-hang-dribble",  name:"Hang Dribble",               tag:"Rhythm Move", difficulty:"advanced",     ageRange:[11,14], funScore:8,  estimatedDuration:90,
    ...
    trainer:"Get Handles Basketball", videoId:"XvQFAjvRtwI", videoChannel:"Get Handles Basketball", trusted:true, videoTitle:"Hang Dribble — Get Handles" },
  ...
  { id:"gh-pullback",      name:"Pullback Dribble",           tag:"Escape",      difficulty:"intermediate", ageRange:[10,14], funScore:7,  estimatedDuration:90,
    ...
    trainer:"Jr. NBA", videoId:"HDHFyQ0DwS4", videoChannel:"Jr. NBA Jr. WNBA", trusted:true, videoTitle:"Fundamentals of the Pull-Back Dribble — Jr. NBA" },
  ...
  { id:"gh-snatch",        name:"Snatch Back",                tag:"Escape",      difficulty:"advanced",     ageRange:[10,14], funScore:9,  estimatedDuration:90,
    ...
    trainer:"ILoveBasketball", videoId:"-Dv4d856RV4", videoChannel:"ILoveBasketballTV", trusted:true, videoTitle:"How to Master the Snatch-Back — ILoveBasketball" },
  ...
  { id:"gh-cross-behind",  name:"Cross → Behind-the-Back",    tag:"Combo",       difficulty:"advanced",     ageRange:[10,14], funScore:9,  estimatedDuration:120,
    ...
    trainer:"Get Handles Basketball", videoId:"XvQFAjvRtwI", videoChannel:"Get Handles Basketball", trusted:true, videoTitle:"Behind-the-Back Combo — Get Handles" },
  ...
  { id:"gh-hang-hesi-cross",name:"Hang → Hesi → Cross",       tag:"Combo",       difficulty:"advanced",     ageRange:[11,14], funScore:9,  estimatedDuration:120,
    ...
    trainer:"PJF Performance", videoId:"qpnJm5_lD30", videoChannel:"PJFPerformance", trusted:true, videoTitle:"Hesi Combos That Freeze Defenders — PJF" },
...
const W_SHOOTING_LAB = [
  { id:"slab-ft-routine",  name:"Free Throw Routine",           tag:"Foundation",  difficulty:"beginner",     ageRange:[9,14],  funScore:5,  estimatedDuration:300,
    ...
    trainer:"TeachHoops", videoId:"upNWZsCtGE8", videoChannel:"Teach Hoops", videoTitle:"Basketball Free Throw Drill" },
  ...
  { id:"slab-catch-shoot", name:"Catch-and-Shoot",              tag:"Foundation",  difficulty:"beginner",     ageRange:[9,14],  funScore:7,  estimatedDuration:180,
    ...
    trainer:"Jr. NBA", videoId:"O5b5HaxCE3U", videoChannel:"Jr. NBA Jr. WNBA", trusted:true, videoTitle:"Catch, Turn, & Shoot Drill" },
  ...
  { id:"slab-curl-cut",    name:"Shot Off a Screen (Curl Cut)",  tag:"Intermediate",difficulty:"intermediate", ageRange:[10,14], funScore:8,  estimatedDuration:120,
    ...
    trainer:"Jr. NBA", videoId:"kWEiiUfGqYM", videoChannel:"Jr. NBA Jr. WNBA", trusted:true, videoTitle:"Fundamentals Of The Curl Cut" },
  ...
  { id:"slab-pullup",      name:"1-Dribble Pull-Up",             tag:"Intermediate",difficulty:"intermediate", ageRange:[10,14], funScore:8,  estimatedDuration:120,
    ...
    trainer:"TeachHoops", videoId:"i3Cq0s2pnWY", videoChannel:"Teach Hoops", videoTitle:"One Dribble Pull-Up Drill - Basketball Shooting" },
  ...
  { id:"slab-elbow",       name:"Elbow Mid-Range",               tag:"Intermediate",difficulty:"intermediate", ageRange:[10,14], funScore:8,  estimatedDuration:120,
    ...
    trainer:"Basketball Shooting Drills", videoId:"ajOtGtnuYks", videoChannel:"DE5TROY", videoTitle:"Basketball Shooting Drill: Elbow Jump Shots | Improve Your Mid Range Game (Pt 2)" },
  ...
  { id:"slab-corner-3",    name:"Corner Three Mechanics",        tag:"Intermediate",difficulty:"intermediate", ageRange:[11,14], funScore:8,  estimatedDuration:120,
    ...
    trainer:"LethalShooter", videoId:"BjOGkKeZVi4", videoChannel:"Lethal Shooter", trusted:true, videoTitle:"The Art of Shooting Lesson #3 (Corner 3)" },
  ...
  { id:"slab-relocation",  name:"Relocation Catch & Shoot",     tag:"Off-Ball",    difficulty:"intermediate", ageRange:[10,14], funScore:8,  estimatedDuration:120,
    ...
    trainer:"HoopStudy", videoId:"8FNOxKUO2ec", videoChannel:"HoopStudy", trusted:true, videoTitle:"Catch and Shoot After Relocation — HoopStudy" },
  ...
  { id:"slab-drift",       name:"Baseline Drift",              tag:"Off-Ball",    difficulty:"intermediate", ageRange:[10,14], funScore:8,  estimatedDuration:120,
    ...
    trainer:"Shoot-A-Way", videoId:"HlvtGoh340w", videoChannel:"Shoot-A-Way", trusted:true, videoTitle:"Baseline Drift Shooting Drill — Shoot-A-Way" },
  ...
  { id:"slab-flare",       name:"Flare Screen Shot",           tag:"Off-Ball",    difficulty:"intermediate", ageRange:[10,14], funScore:8,  estimatedDuration:120,
    ...
    trainer:"Dr. Dish Basketball", videoId:"85WXNSGpV3w", videoChannel:"Dr. Dish Basketball", videoTitle:"Flare Screen Shooting Drill — Dr. Dish" },
  ...
  { id:"slab-pin-down",    name:"Pin-Down Shot",               tag:"Off-Ball",    difficulty:"intermediate", ageRange:[10,14], funScore:8,  estimatedDuration:120,
    ...
    trainer:"Pure Sweat Basketball", videoId:"5AlLE0y7ALc", videoChannel:"Pure Sweat Basketball", trusted:true, videoTitle:"Pin-Down Shooting Drills — Pure Sweat" },
  ...
  { id:"slab-dho",         name:"Dribble Hand-Off (DHO)",      tag:"Off-Ball",    difficulty:"intermediate", ageRange:[10,14], funScore:8,  estimatedDuration:120,
    ...
    trainer:"Dr. Dish Basketball", videoId:"yLccPEHr_ow", videoChannel:"Dr. Dish Basketball", videoTitle:"DHO Drift Kick-Back — Dr. Dish" },
  ...
  { id:"slab-transition-shot",name:"Sprint Into Shot",         tag:"Transition",  difficulty:"intermediate", ageRange:[10,14], funScore:8,  estimatedDuration:120,
    ...
    trainer:"HoopStudy", videoId:"dqOlxbOU_jM", videoChannel:"HoopStudy", trusted:true, videoTitle:"One-on-One Preseason Shooting — HoopStudy" },
  ...
  { id:"slab-zoom",        name:"Zoom Action Shot",            tag:"Off-Ball",    difficulty:"advanced",     ageRange:[11,14], funScore:8,  estimatedDuration:120,
    ...
    trainer:"Matt Hackenberg", videoId:"zQWSVtc_9ds", videoChannel:"Matt Hackenberg", videoTitle:"Zoom Action Explained — Hackenberg" },
  ...
  { id:"slab-pullup-1",    name:"One-Dribble Pull-Up",         tag:"Off Dribble", difficulty:"intermediate", ageRange:[10,14], funScore:8,  estimatedDuration:120,
    ...
    trainer:"Dr. Dish Basketball", videoId:"2wRnQ_iqiMY", videoChannel:"Dr. Dish Basketball", videoTitle:"One-Dribble Pull-Up Shooting — Dr. Dish" },
  ...
  { id:"slab-pullup-2",    name:"Two-Dribble Pull-Up",         tag:"Off Dribble", difficulty:"intermediate", ageRange:[10,14], funScore:8,  estimatedDuration:120,
    ...
    trainer:"ILoveBasketball", videoId:"6qTUj818flI", videoChannel:"ILoveBasketballTV", trusted:true, videoTitle:"Smooth Pull-Up Jumper — ILoveBasketball" },
  ...
  { id:"slab-side-step",   name:"Side-Step Three",             tag:"Off Dribble", difficulty:"advanced",     ageRange:[11,14], funScore:9,  estimatedDuration:120,
    ...
    trainer:"HoopStudy", videoId:"MEYxJCYvGGs", videoChannel:"HoopStudy", trusted:true, videoTitle:"Side-Step Separation Shooting — HoopStudy" },
  ...
  { id:"slab-floater",     name:"Floater / Runner",            tag:"Finishing",   difficulty:"intermediate", ageRange:[10,14], funScore:8,  estimatedDuration:120,
    ...
    trainer:"HoopStudy", videoId:"UR16q3SMUtY", videoChannel:"HoopStudy", trusted:true, videoTitle:"Improve Your Floater — HoopStudy" },
  ...
  { id:"slab-reject",      name:"Reject the Screen",           tag:"Counter",     difficulty:"advanced",     ageRange:[11,14], funScore:8,  estimatedDuration:120,
    ...
    trainer:"HoopStudy", videoId:"42Fkun6Yvlk", videoChannel:"HoopStudy", trusted:true, videoTitle:"Try Rejecting the Ball-Screen — HoopStudy" },
];
...
const W_BASKETBALL_IQ = [
  { id:"iq-closeout",    name:"Attack the Closeout",              tag:"Reads",       difficulty:"beginner",     ageRange:[9,14],  funScore:8,  estimatedDuration:120,
    ...
    trainer:"Basketball Education", videoId:"FqF7sq6fe8k", videoChannel:"The Scoring Factory", videoTitle:"Basketball Education: Attack Closeout" },
  ...
  { id:"iq-shot-drive",  name:"Shot or Drive Read",               tag:"Reads",       difficulty:"beginner",     ageRange:[9,14],  funScore:8,  estimatedDuration:120,
    ...
    trainer:"Championship Productions", videoId:"Dupz4awdQGI", videoChannel:"Championship Productions", videoTitle:"Improve Your Offense by Learning to Read the Defender!" },
  ...
  { id:"iq-read-def",    name:"Reading Defensive Positioning",    tag:"Reads",       difficulty:"intermediate", ageRange:[10,14], funScore:7,  estimatedDuration:120,
    ...
    trainer:"Basketball IQ", videoId:"jnJHFtUgO58", videoChannel:"SLskillsfactory", videoTitle:"Basketball Training: Close Out to Attack Drill" },
  ...
  { id:"iq-spacing",     name:"Floor Spacing Basics",             tag:"Concepts",    difficulty:"beginner",     ageRange:[9,14],  funScore:7,  estimatedDuration:120,
    ...
    trainer:"JP Productions", videoId:"ySbLZmFWnSw", videoChannel:"Jez Phipps", videoTitle:"Basketball Spacing Made For Beginners! *Learn How To Space The Floor*" },
  ...
  { id:"iq-help-side",   name:"Help Side Defense Principles",     tag:"Concepts",    difficulty:"intermediate", ageRange:[10,14], funScore:7,  estimatedDuration:120,
    ...
    trainer:"Upward Sports", videoId:"ES7MVSegkSs", videoChannel:"Upward Sports", videoTitle:"Help Side Defense Principle" },
  ...
  { id:"iq-transition",  name:"Transition Decision-Making",       tag:"Concepts",    difficulty:"intermediate", ageRange:[10,14], funScore:9,  estimatedDuration:120,
    ...
    trainer:"Smart Offense Basketball", videoId:"1LxBSNKO26o", videoChannel:"PGC Coaching", videoTitle:"Using The Whole Floor In Transition | Smart Offense for Basketball Coaches" },
];
...
const W_PASSING = [
  { id:"pass-wall-chest", name:"Wall Chest Pass", tag:"Passing", setup:"solo",
    ...
    trainer:"Squatch Sports", videoId:"Xu5dnbIQdqk", videoChannel:"Squatch Sports", videoTitle:"Chest Pass Basics — Squatch Sports" },
  { id:"pass-wall-bounce", name:"Wall Bounce Pass", tag:"Passing", setup:"solo",
    ...
    trainer:"STACK Basketball Training", videoId:"Guig8aK0DxU", videoChannel:"STACK Basketball Training", trusted:true, videoTitle:"Bounce Passing Drill — STACK" },
  { id:"pass-one-hand", name:"One-Hand Push Pass", tag:"Passing", setup:"solo",
    ...
    trainer:"The Scoring Factory", videoId:"PAdBXaAwCWE", videoChannel:"The Scoring Factory", videoTitle:"One-Hand Push Pass — The Scoring Factory" },
  { id:"pass-pivot", name:"Pivot & Pass", tag:"Footwork", setup:"solo",
    ...
    trainer:"HoopStudy", videoId:"jEAvb1gcbc0", videoChannel:"HoopStudy", trusted:true, videoTitle:"Pivot Footwork — HoopStudy" },
  { id:"pass-off-dribble", name:"Pass Off the Dribble", tag:"Game Pass", setup:"solo",
    ...
    trainer:"Cramer Basketball", videoId:"MDI9TchTP30", videoChannel:"Cramer Basketball", trusted:true, videoTitle:"Passing Off the Dribble — Cramer Basketball" },
  { id:"pass-kick-out", name:"Drive & Kick (Wall)", tag:"Game Pass", setup:"solo",
    ...
    trainer:"Rangerockers TV", videoId:"Wvufu3GtTfg", videoChannel:"MuchachoTv", videoTitle:"Drive, Kick & Swing — Rangerockers" },
  { id:"pass-skip", name:"Skip Pass (Wall)", tag:"Game Pass", setup:"solo",
    ...
    trainer:"Hoop Dreams Basketball", videoId:"mrDC6EP4RuA", videoChannel:"Hoop Dreams Basketball 🏀🧠", videoTitle:"What Is a Skip Pass? — Hoop Dreams" },
  { id:"pass-pocket", name:"Pocket Pass (Wall)", tag:"Game Pass", setup:"solo",
    ...
    trainer:"Ryan Razooky (R2BBALL)", videoId:"fbep5jy3X6I", videoChannel:"Ryan Razooky (R2BBALL)", videoTitle:"Perfect Your Pocket Pass — R2BBALL" },
];
...
const W_DEFENSE = [
  { id:"def-lateral",  name:"Lateral Slide",         tag:"On-Ball",  difficulty:"beginner",     ageRange:[9,14],  funScore:6,  estimatedDuration:90,
    ...
    trainer:"Jr. NBA", videoId:"4A6KqSJX8Ek", videoChannel:"Jr. NBA Jr. WNBA", trusted:true, videoTitle:"Fundamentals of a Defensive Stance — Jr. NBA" },
  { id:"def-contain",  name:"On-Ball Containment",   tag:"On-Ball",  difficulty:"intermediate", ageRange:[10,14], funScore:8,  estimatedDuration:90,
    ...
    trainer:"Brian McCormick", videoId:"voDcaAlaHDU", videoChannel:"Brian McCormick", trusted:true, videoTitle:"Youth 1v1 Containment — Brian McCormick" },
  { id:"def-contest",  name:"Shot Contest (No Foul)", tag:"Closeout", difficulty:"beginner",     ageRange:[9,14],  funScore:7,  estimatedDuration:60,
    ...
    trainer:"Basketball Coach Allen", videoId:"wAN8lPIQqco", videoChannel:"Basketball Coach Allen", videoTitle:"How to Contest Shots Without Fouling" },
...
const EXERCISE_META = {
  ...
  /* ─── PASSING ─── wall-based, trainable solo. Equipment reflects that a wall is required. */
  "pass-wall-chest":     { difficulty:"beginner",     impactLevel:"low",    intensityLevel:"low",    movementType:"skill",     bodyFocus:["chest","arms","hands"],        basketballTransfer:["passing","mechanics"],                    equipment:"basketball + wall", spaceRequired:"small",  ageRange:[9,17],  estimatedDuration:90,  funScore:5, workoutRole:["warmup","main"], progressionTrack:"Step 1 — Passing Foundation" },
  "pass-wall-bounce":    { difficulty:"beginner",     impactLevel:"low",    intensityLevel:"low",    movementType:"skill",     bodyFocus:["chest","arms","hands"],        basketballTransfer:["passing","mechanics"],                    equipment:"basketball + wall", spaceRequired:"small",  ageRange:[9,17],  estimatedDuration:90,  funScore:5, workoutRole:["warmup","main"], progressionTrack:"Step 1 — Passing Foundation" },
  "pass-one-hand":       { difficulty:"beginner",     impactLevel:"low",    intensityLevel:"low",    movementType:"skill",     bodyFocus:["arms","hands","core"],         basketballTransfer:["passing","off-the-dribble"],              equipment:"basketball + wall", spaceRequired:"small",  ageRange:[9,17],  estimatedDuration:90,  funScore:6, workoutRole:["main"],          progressionTrack:"Step 1 — Passing Foundation" },
  "pass-pivot":          { difficulty:"beginner",     impactLevel:"low",    intensityLevel:"medium", movementType:"skill",     bodyFocus:["feet","hips","hands"],         basketballTransfer:["passing","footwork"],                     equipment:"basketball + wall", spaceRequired:"small",  ageRange:[9,17],  estimatedDuration:120, funScore:6, workoutRole:["main"],          progressionTrack:"Step 2 — Passing on the Move" },
  "pass-off-dribble":    { difficulty:"intermediate", impactLevel:"low",    intensityLevel:"medium", movementType:"skill",     bodyFocus:["hands","hips","core"],         basketballTransfer:["passing","off-the-dribble"],              equipment:"basketball + wall", spaceRequired:"small",  ageRange:[10,17], estimatedDuration:120, funScore:7, workoutRole:["main"],          progressionTrack:"Step 2 — Passing on the Move" },
  "pass-kick-out":       { difficulty:"intermediate", impactLevel:"medium", intensityLevel:"medium", movementType:"skill",     bodyFocus:["hands","legs","core"],         basketballTransfer:["passing","driving","decision-making"],    equipment:"basketball + wall", spaceRequired:"medium", ageRange:[10,17], estimatedDuration:120, funScore:8, workoutRole:["main"],          progressionTrack:"Step 3 — Game Passes" },
  "pass-skip":           { difficulty:"intermediate", impactLevel:"low",    intensityLevel:"medium", movementType:"skill",     bodyFocus:["arms","core","shoulders"],     basketballTransfer:["passing","spacing"],                      equipment:"basketball + wall", spaceRequired:"medium", ageRange:[10,17], estimatedDuration:120, funScore:7, workoutRole:["main"],          progressionTrack:"Step 3 — Game Passes" },
  "pass-pocket":         { difficulty:"advanced",     impactLevel:"low",    intensityLevel:"medium", movementType:"skill",     bodyFocus:["hands","hips","core"],         basketballTransfer:["passing","decision-making"],              equipment:"basketball + wall", spaceRequired:"small",  ageRange:[11,17], estimatedDuration:120, funScore:7, workoutRole:["main"],          progressionTrack:"Step 3 — Game Passes" },
  /* ─── REBOUNDING ─── needs a rim; jumping work is impact-rated accordingly. */
  "reb-self-toss":       { difficulty:"beginner",     impactLevel:"medium", intensityLevel:"medium", movementType:"athletic",  bodyFocus:["legs","hands","core"],         basketballTransfer:["rebounding","jumping"],                   equipment:"basketball + hoop", spaceRequired:"medium", ageRange:[9,17],  estimatedDuration:120, funScore:7, workoutRole:["main"],          progressionTrack:"Step 1 — Go Get the Ball" },
  "reb-tips":            { difficulty:"intermediate", impactLevel:"high",   intensityLevel:"high",   movementType:"elastic",   bodyFocus:["legs","hands","shoulders"],    basketballTransfer:["rebounding","touch"],                     equipment:"basketball + hoop", spaceRequired:"medium", ageRange:[10,17], estimatedDuration:120, funScore:8, workoutRole:["main"],          progressionTrack:"Step 2 — Timing & Touch" },
  "reb-boxout":          { difficulty:"beginner",     impactLevel:"low",    intensityLevel:"medium", movementType:"skill",     bodyFocus:["hips","legs","core"],          basketballTransfer:["rebounding","footwork"],                  equipment:"none",              spaceRequired:"small",  ageRange:[9,17],  estimatedDuration:90,  funScore:5, workoutRole:["main"],          progressionTrack:"Step 1 — Go Get the Ball" },
  "reb-outlet":          { difficulty:"intermediate", impactLevel:"medium", intensityLevel:"medium", movementType:"athletic",  bodyFocus:["legs","core","arms"],          basketballTransfer:["rebounding","passing","transition"],      equipment:"basketball + hoop", spaceRequired:"medium", ageRange:[10,17], estimatedDuration:120, funScore:7, workoutRole:["main"],          progressionTrack:"Step 2 — Timing & Touch" },
  "reb-power":           { difficulty:"intermediate", impactLevel:"high",   intensityLevel:"high",   movementType:"athletic",  bodyFocus:["legs","core","shoulders"],     basketballTransfer:["rebounding","contact-finishing"],         equipment:"basketball + hoop", spaceRequired:"medium", ageRange:[10,17], estimatedDuration:120, funScore:8, workoutRole:["main"],          progressionTrack:"Step 3 — Finish the Play" },
  /* ─── PARTNER & GAMES ─── every one needs a second person; equipment says so explicitly. */
  "pg-partner-pass":     { difficulty:"beginner",     impactLevel:"low",    intensityLevel:"medium", movementType:"skill",     bodyFocus:["hands","arms","feet"],         basketballTransfer:["passing","mechanics"],                    equipment:"partner",           spaceRequired:"medium", ageRange:[9,17],  estimatedDuration:180, funScore:8, workoutRole:["warmup","main"], progressionTrack:"Step 1 — Work With a Partner" },
  "pg-closeout-read":    { difficulty:"intermediate", impactLevel:"medium", intensityLevel:"medium", movementType:"skill",     bodyFocus:["feet","eyes","hips"],          basketballTransfer:["decision-making","basketball-IQ"],        equipment:"partner",           spaceRequired:"medium", ageRange:[10,17], estimatedDuration:180, funScore:8, workoutRole:["main"],          progressionTrack:"Step 2 — Read the Defender" },
  "pg-1v1":              { difficulty:"intermediate", impactLevel:"high",   intensityLevel:"high",   movementType:"athletic",  bodyFocus:["legs","hips","core"],          basketballTransfer:["decision-making","attacking","defense"],  equipment:"partner",           spaceRequired:"large",  ageRange:[10,17], estimatedDuration:300, funScore:10, workoutRole:["main","finisher"], progressionTrack:"Step 2 — Read the Defender" },
  "pg-boxout-live":      { difficulty:"intermediate", impactLevel:"high",   intensityLevel:"high",   movementType:"athletic",  bodyFocus:["hips","legs","core"],          basketballTransfer:["rebounding","footwork"],                  equipment:"partner",           spaceRequired:"medium", ageRange:[10,17], estimatedDuration:180, funScore:8, workoutRole:["main"],          progressionTrack:"Step 2 — Read the Defender" },
  "pg-2v2":              { difficulty:"advanced",     impactLevel:"high",   intensityLevel:"high",   movementType:"athletic",  bodyFocus:["legs","lungs","core"],         basketballTransfer:["team-offense","spacing","decision-making"], equipment:"partner",         spaceRequired:"large",  ageRange:[11,17], estimatedDuration:420, funScore:10, workoutRole:["main","finisher"], progressionTrack:"Step 3 — Play the Game" },
  "pg-3v3":              { difficulty:"advanced",     impactLevel:"high",   intensityLevel:"high",   movementType:"athletic",  bodyFocus:["legs","lungs","core"],         basketballTransfer:["team-offense","spacing","decision-making"], equipment:"partner",         spaceRequired:"large",  ageRange:[11,17], estimatedDuration:600, funScore:10, workoutRole:["main","finisher"], progressionTrack:"Step 3 — Play the Game" },
...
const WORKOUT_TEMPLATES = {
  ...
  interior:  { name:"Post & Boards",       emoji:"🙌", desc:"Score with your back to the basket and go get the rebound.", cats:["postmoves","rebounding"],                 structure:{warmup:1,main:3,finisher:1,recovery:0}, ageMin:9  },
  passing:   { name:"Passing",             emoji:"↗️", desc:"Chest, bounce, and game passes — all trainable off a wall, alone.", cats:["passing"],                          structure:{warmup:1,main:3,finisher:1,recovery:0}, ageMin:9  },
  /* Partner-only: every drill in `partner_games` needs a second person, so it gets its own
     template rather than being mixed into the solo pools where a kid training alone would
     be served a 3v3. */
  partner:   { name:"Partner & Games",     emoji:"👥", desc:"Live reps with a training partner — reads, box-outs, and small-sided games.", cats:["partner_games"], structure:{warmup:1,main:3,finisher:1,recovery:0}, ageMin:9, requiresPartner:true },
};

const SCHED_TO_TEMPLATE = { explosion:"jump",deceleration:"jump",speed:"quickFeet",coordination:"quickFeet",athletic:"quickFeet",strength:"fullBody",conditioning:"fullBody",balance:"recovery",handles:"handles",game_handles:"handles",ballhandling:"handles",basketball_iq:"handles",shooting:"shooting",shooting_lab:"shooting",shootingdrills:"shooting",defense:"defense",finishing:"finishing",finishing_school:"finishing",footwork:"finishing",footwork_lab:"finishing",postmoves:"interior",rebounding:"interior",passing:"passing",partner_games:"partner" };
